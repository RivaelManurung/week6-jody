...
import 'package:week6sesidua/flutter_application_sayurmayur/widget/navbar_widget.dart';
...
class SayurDetail extends StatelessWidget {
  ...
  Future<void> _launchWhatsApp(String phone, String message) async {
    final Uri whatsappUrl = Uri.parse("https://wa.me/$phone?text=${Uri.encodeFull(message)}");
              ...
              child: Center(
                child: InkWell(
                  onTap: () async {
                    _launchWhatsApp(
                      '628123456789',
                      'Hi Tegar Sayur, Saya mau order $sayurname untuk hari ini, apa bisa diantar ke rumah',
                    );
                  },
                  child: Row(
